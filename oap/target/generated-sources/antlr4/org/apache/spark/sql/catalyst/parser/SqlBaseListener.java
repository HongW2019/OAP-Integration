...
public interface SqlBaseListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code oapDisableIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterOapDisableIndex(SqlBaseParser.OapDisableIndexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code oapDisableIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitOapDisableIndex(SqlBaseParser.OapDisableIndexContext ctx);
	/**
	 * Enter a parse tree produced by the {@code oapEnableIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void enterOapEnableIndex(SqlBaseParser.OapEnableIndexContext ctx);
	/**
	 * Exit a parse tree produced by the {@code oapEnableIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 */
	void exitOapEnableIndex(SqlBaseParser.OapEnableIndexContext ctx);
	/**
