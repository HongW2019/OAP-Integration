...
public interface SqlBaseVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code oapDisableIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapDisableIndex(SqlBaseParser.OapDisableIndexContext ctx);
	/**
	 * Visit a parse tree produced by the {@code oapEnableIndex}
	 * labeled alternative in {@link SqlBaseParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitOapEnableIndex(SqlBaseParser.OapEnableIndexContext ctx);
	/**
